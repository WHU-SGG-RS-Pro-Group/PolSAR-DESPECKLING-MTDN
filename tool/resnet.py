...
class ModifiedResNet18(ResNet):
    def __init__(self, in_channels=4, **kwargs):
        # Call the constructor of the parent ResNet class
        super(ModifiedResNet18, self).__init__(BasicBlock, [2, 2, 2, 2], **kwargs)

        # Modify the first convolution layer to accept the new number of input channels
        self.conv1 = nn.Conv2d(in_channels, 64, kernel_size=7, stride=2, padding=3, bias=False)


# Create an instance of the modified ResNet-18 with 4 input channels
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        self.conv1 = nn.Conv2d(7, self.inplanes, kernel_size=7, stride=self.strides[0], padding=3,
                               bias=False)
