...
from tool.help_funcs import Transformer, TransformerDecoder, TwoLayerConv2d
from tool.resnet import *
...
class ResNet(torch.nn.Module):
    ...
    def forward_single(self, x):
        ...
        x_4 = self.resnet.layer1(x) # 1/4, in=64, out=64   25*25
        x_8 = self.resnet.layer2(x_4) # 1/8, in=64, out=128   13*13
        ...
        # x= F.interpolate(x, size=(25, 25), mode='bicubic', align_corners=False)
        return x
...
class BASE_Transformer(ResNet):
    ...
    def __init__(self, input_nc, output_nc, with_pos, resnet_stages_num=5,
        ...
        # self.CA=ChannelAttention(num_feat=32)
